...
from dqn_atari.agents.double_dqn_agent import calc_double_dqn_loss
...
def main():
    ...
    writer = SummaryWriter(comment="-" + args.env + "-double-dqn")
    print(net)
    ...
    while True:
        ...
        if reward is not None:
            ...
            if best_m_reward is None or best_m_reward < m_reward:
                torch.save(net.state_dict(), args.env + "-double_dqn-best_%.0f.dat" % m_reward)
        ...
        loss_t = calc_double_dqn_loss(batch, net, target_net, GAMMA, device)
        loss_t.backward()
        optimizer.step()
